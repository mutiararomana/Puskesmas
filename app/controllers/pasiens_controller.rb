...
#    end
  ...
  def cetak_laporan
      respond_to do |format|
            format.html { render }
            format.pdf do
                render pdf: "lb1", :template => 'pasiens/cetak_laporan.html.erb', :orientation => 'Landscape'
            end
        end
  end
